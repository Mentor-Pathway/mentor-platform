...
Challenge.create( complete: "28/10/2022", notes: "Just to advise you that this is a test run.", feedback: "You are doing really well, keep it up son", rating: "4", user_id: User.last.id)
